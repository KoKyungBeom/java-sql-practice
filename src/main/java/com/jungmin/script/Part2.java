...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users (username,email,password) VALUES ('ABC','ABC@gmail.com','ABC123')";
  ...
  */
  public static final String PART2_7 = "SELECT u.username,p.title FROM Posts AS p LEFT JOIN Users AS u ON u.user_id = p.user_id";
  ...
  */
  public static final String PART2_8 = "SELECT u.username,p.title FROM Posts AS p JOIN Users AS u ON u.user_id = p.user_id";
  ...
  */
  public static final String PART2_10 = "INSERT INTO Posts (title,content,user_id) VALUES ('Cat','Cute LuckyKim','1')";
  ...
  */
  public static final String PART2_14 = "SELECT p.title,p.content,p.created_at FROM Posts AS p JOIN Boards AS b ON p.board_id = b.board_id WHERE b.name = 'General Discussion'";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-15. luckykim이 작성한 comment의 개수 (컬럼명: CommentCount)를 출력하기 위한 SQL을 작성해주세요.
  */
  public static final String PART2_15 = "SELECT COUNT(c.user_id) AS CommentCount FROM Comments AS c JOIN Users AS u ON c.user_id = u.user_id WHERE u.username = 'luckykim'";
  ...
  */
  public static final String PART2_16 = "SELECT u.username,COUNT(c.user_id) AS CommentCount FROM Users AS u LEFT JOIN Comments AS c ON u.user_id = c.user_id GROUP BY u.username";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-17. 각 board의 name과 해당 board에 속한 post의 개수 (컬럼명: PostCount)를 출력하기 위한 SQL을 작성해주세요.
  */
  public static final String PART2_17 = "SELECT b.name,COUNT(p.board_id) AS PostCount FROM Boards AS b LEFT JOIN Posts AS p ON b.board_id = p.board_id GROUP BY b.name";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-18. 각 board의 name과 해당 board에 속한 posts 테이블의 content의 평균 길이 (컬럼명: AvgLength)를 출력하기 위한 SQL을 작성해주세요.")
  */
  public static final String PART2_18 = "SELECT b.name,AVG(CHAR_LENGTH(p.content)) AS AvgLength FROM Boards AS b LEFT JOIN Posts AS p ON b.board_id = p.board_id GROUP BY b.name";
  ...
  */
  public static final String PART2_19 = "SELECT b.name,AVG(CHAR_LENGTH(p.content)) AS AvgLength FROM Boards AS b JOIN Posts AS p ON b.board_id = p.board_id GROUP BY b.name";
  ...
  */
  public static final String PART2_20 = "SELECT t.name,COUNT(pt.post_id) AS PostCount FROM Tags AS t LEFT JOIN Post_Tags AS pt ON t.tag_id = pt.tag_id GROUP BY t.name";
}
